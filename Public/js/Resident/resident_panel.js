...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.loadSection = function(view, params = '') {
        ...
        const url = `/resident/content/${view}${params}`;
    ...
    window.initializeView = function(view) {
        ...
        if (view === 'residents' && typeof initializeResidentsView === 'function') {
            initializeResidentsView();
        }
        // Añade aquí 'else if' para otras vistas que necesiten inicialización JS
        // else if (view === 'avisos' && typeof initializeAvisosView === 'function') {
